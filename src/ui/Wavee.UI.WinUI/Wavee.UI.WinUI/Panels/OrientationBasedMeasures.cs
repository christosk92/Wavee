...
{
    public static Rect WithHeight(this Rect x, double height)
    {
        return new Rect(x._x, x._y, x._width, height);
    }
    public static Rect WithWidth(this Rect x, double width)
    {
        return new Rect(x._x, x._y, width, x._height);
    }

    public static Rect WithX(this Rect a, double x)
    {
        return new Rect(x, a._y, a._width, a._height);
    }
    public static Rect WithY(this Rect a, double y)
    {
        return new Rect(a._x, y, a._width, a._height);
    }
    ...
    {
        return new Vector2(rect._x, rect._y);
    }
}