    ...
    public class StackLayout : VirtualizingLayout, IFlowLayoutAlgorithmDelegates
    {
        ...
        public static readonly DependencyProperty OrientationProperty =
            DependencyProperty.Register(
                ...
                typeof(Orientation),
                typeof(StackLayout),
                new PropertyMetadata(Microsoft.UI.Xaml.Controls.Orientation.Vertical, PropertyChangedCallback));
        ...
        protected void OnPropertyChanged(DependencyPropertyChangedEventArgs dependencyPropertyChangedEventArgs)
        {
            if (dependencyPropertyChangedEventArgs.Property == OrientationProperty)
            {
                var orientation = (Orientation)dependencyPropertyChangedEventArgs.NewValue;
