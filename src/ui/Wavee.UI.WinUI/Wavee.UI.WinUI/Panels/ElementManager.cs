...
internal class ElementManager
{
        ...
        if (_context != null)
        {
            ...
            else
            {
                ...
                if (_realizedElementLayoutBounds.Count != count)
                {
                    ...
                    _realizedElementLayoutBounds.EnsureCapacity(count);
                }
            }
        }
    }
    ...
    public void Insert(int realizedIndex, int dataIndex, UIElement? element)
    {
        ...
        _realizedElementLayoutBounds.Insert(realizedIndex, new Rect(-1, -1, 0, 0));
    }
    ...
    public bool IsWindowConnected(in Rect window, ScrollOrientation orientation, bool scrollOrientationSameAsFlow)
    {
        ...
        if (_realizedElementLayoutBounds.Count > 0)
        {
            ...
            var effectiveOrientation = scrollOrientationSameAsFlow ?
                (orientation == ScrollOrientation.Vertical ? ScrollOrientation.Horizontal : ScrollOrientation.Horizontal) :
                orientation;
