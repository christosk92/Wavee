...
namespace Eum.UI.WinUI.Controls
{
    ...
    public static partial class ListViewExtensions
    {
        ...
        public static async Task SmoothScrollIntoViewWithIndexAsync(this ListViewBase listViewBase, int index, ScrollItemPlacement itemPlacement = ScrollItemPlacement.Default, bool disableAnimation = false, bool scrollIfVisible = true, int additionalHorizontalOffset = 0, int additionalVerticalOffset = 0)
        {
            ...
            S_Log.Instance.LogInfo($"New index: {index}");
            ...
            {
                S_Log.Instance.LogInfo("SelectorItem is null!");
                isVirtualizing = true;
            ...
            if (isVirtualizing)
            {
                S_Log.Instance.LogInfo("Is virtualizing!");
            ...
            else
            {
                switch (itemPlacement)
                {
                    ...
                    case ScrollItemPlacement.Top:
                        finalXPosition = previousXOffset + additionalHorizontalOffset;
                        finalYPosition = maxYPosition + additionalVerticalOffset - selectorItemHeight;
                        S_Log.Instance.LogInfo($"Setting Final Y  to {finalYPosition} (maxyPos: {maxYPosition}, add_v_off = {additionalVerticalOffset}, seleItemHeight: {selectorItemHeight}");
                        break;
