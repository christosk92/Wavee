...
namespace Wavee.UI.WinUI.Components
{
    public sealed partial class ArtistCardView : UserControl
    {
        ...
        private void ArtistCardView_OnTapped(object sender, TappedRoutedEventArgs e)
        {
            UICommands.NavigateTo.Execute(Id);
            //ConnectedAnimationService.GetForCurrentView().PrepareToAnimate("ForwardConnectedAnimation", TitleBlock);
        }
    }
}
