...
{
    public const string RecentlyPlayedSection = "HomeRecentlyPlayedSectionData";
    public const string AlbumPlaceholderImageId = "ms-appx:///Assets/AlbumPlaceholder.png";
