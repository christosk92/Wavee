...
//     }
//
//     public static SpotifyArtistView From(Stream stream, AudioId artistId)
//     {
//         using var jsonDoc = JsonDocument.Parse(stream);
//         try
//         {
//             var artist = jsonDoc.RootElement.GetProperty("data").GetProperty("artistUnion");
//
...
//                 var items = release.GetProperty("items");
//             }
//
//             var res = new List<ArtistDiscographyGroupView>(3);
//             GetView(discography, "albums", true, false, res);
//             GetView(discography, "singles", true, false, res);
//             GetView(discography, "compilations", false, false, res);
//
//
...
//     }
//
//     public static SpotifyArtistView From(ReadOnlyMemory<byte> jsonDoc, AudioId artistId)
//     {
