...
namespace Eum.UI.Helpers
{
    ...
    {
        /// <summary>
        /// Creates a <see cref="System.Drawing.Color"/> from a XAML color string.
        /// Any format used in XAML should work.
        /// </summary>
        /// <param name="colorString">The XAML color string.</param>
        /// <returns>The created <see cref="System.Drawing.Color"/>.</returns>
        public static System.Drawing.Color ToColor(this string colorString)
        {
        ...
        /// <summary>
        /// Converts a <see cref="Color"/> to an <see cref="ColorThiefDotNet.HslColor"/>.
        /// </summary>
        /// <param name="color">The <see cref="Color"/> to convert.</param>
        /// <returns>The converted <see cref="ColorThiefDotNet.HslColor"/>.</returns>
