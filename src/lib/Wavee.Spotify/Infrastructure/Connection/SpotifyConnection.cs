...
internal static class SpotifyConnection
{
    ...
    public static SpotifyConnectionRecord Handshake(NetworkStream stream)
    {
        ...
        return new SpotifyConnectionRecord(
            computedKeys.SendKey,
            computedKeys.ReceiveKey,
            0,
            0);
    }
...
internal readonly ref struct SpotifyRawPacket
{
    public required ReadOnlySpan<byte> Header { get; init; }
