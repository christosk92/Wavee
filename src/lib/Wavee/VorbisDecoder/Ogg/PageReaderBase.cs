using Wavee.VorbisDecoder.Contracts.Ogg;

namespace Wavee.VorbisDecoder.Ogg
{
    abstract class PageReaderBase : IPageReader
    {
        ...
        private readonly System.Collections.Generic.HashSet<int> _ignoredSerials = new System.Collections.Generic.HashSet<int>();
