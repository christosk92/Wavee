...
namespace Wavee.Spotify.Sys.Playback.Streams;
...
internal sealed class EncryptedSpotifyStream<RT> where RT : struct, HasHttp<RT>
{
    ...
    {
        var chunkToRead = (int)(Position / SpotifyStreamRuntime.ChunkSize);
        var chunkOffset = (int)(Position % SpotifyStreamRuntime.ChunkSize);
