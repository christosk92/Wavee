...
using Wavee.UI.Generators.Generators;

namespace Wavee.UI.Generators.Analyzers;
...
{
    public const string UiContextType = "Wavee.ViewModels.Models.UI.UiContext";
    public const string UiContextFileSuffix = "_UiContext.cs";
    public const string DialogViewModelBaseType = "Wavee.ViewModels.ViewModels.Dialogs.Base.DialogViewModelBase<TResult>";
