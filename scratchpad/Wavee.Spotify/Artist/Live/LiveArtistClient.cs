...
internal readonly struct LiveArtistClient : IArtistClient
{
    ...
    public async Task<Paged<SpotifyArtistDiscographyReleaseWrapper>> GetDiscographyAsync(SpotifyId id,
        ...
        int limit, CancellationToken cancellationToken = default)
    {
        ...
        await using var stream = await httpResponse.Content.ReadAsStreamAsync(cancellationToken);
        return Paged<SpotifyArtistDiscographyReleaseWrapper>.ParsePagedDiscographyFrom(stream, type, offset, limit);
    }
}