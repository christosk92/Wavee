...
internal static class HandshakeIO
{
    public static (ReadOnlyMemory<byte> SendKey, ReadOnlyMemory<byte> ReceiveKey) Handshake(NetworkStream stream)
    {
        ...
        return (computedKeys.SendKey, computedKeys.ReceiveKey);
    }
    ...
    public readonly struct SpotifyAuthenticationKeys
    {
        ...
        public SpotifyAuthenticationKeys(ReadOnlyMemory<byte> sendKey, ReadOnlyMemory<byte> receiveKey, ReadOnlyMemory<byte> challenge)
        {
            SendKey = sendKey;
